...
m44 vt0.xyzw, a_position.xyzw, vc0
...
abs vt1.x, vt0.xxxx
mov vt1.y, u_modelViewMatrix.yyxx
mov vt1.z, u_modelViewMatrix.zzzx
mov vt1.x, u_modelViewMatrix.xxxx
...
nrm vt1.xyz, a_normal.xyzx
crs vt0.xyz, vt1.xyzx, vc9.xyzx
crs vt3.xyz, vt0.xyzx, vt1.xyzx
mov v1, vc0
m33 v1.xyz, vt3.xyzx, vt4

mov v2, vc0
m33 v2.xyz, vt0.xyzx, vt4

mov v3, vc0
m33 v3.xyz, vt1.xyzx, vt4
mov vt3.z, vc10.yyyx
